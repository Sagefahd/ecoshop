...
class Order(models.Model):
    ...
    primary_address = models.ForeignKey(Address, on_delete=models.PROTECT, related_name="+")
    secondary_address = models.ForeignKey(Address, on_delete=models.PROTECT, related_name="+")
